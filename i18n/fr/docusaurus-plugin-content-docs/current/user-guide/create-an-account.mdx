...
<figure>
  <img
    src={
      require("@site/static/img/user-guide/create-an-account-1.webp").default
    }
  />
</figure>
...
<figure>
  <img
    src={
      require("@site/static/img/user-guide/create-an-account-2.webp").default
    }
  />
</figure>
...
<figure>
  <img
    src={
      require("@site/static/img/user-guide/create-an-account-3.webp").default
    }
  />
</figure>
...
<figure>
  <img
    src={
      require("@site/static/img/user-guide/create-an-account-4.webp").default
    }
  />
</figure>
